...
INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_user_role', 'bob@supatype.dev')
RETURNING
    * \gset bob_

INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_user_role', 'alice@supatype.dev')
RETURNING
    * \gset alice_

INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_admin_role', 'admin@supatype.dev')
RETURNING
    * \gset admin_

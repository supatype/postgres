# Getting Started with Supatype Postgres


This guide covers getting up and running with Supatype Postgres. After reading this guide, you will understand:

* What Supatype Postgres provides and why you might want to use it
...
Supatype Postgres follows these core principles:
...
Extensions are the superpower of PostgreSQL. They add functionality without modifying the core database. Supatype Postgres includes dozens of pre-built extensions covering:
...
docker build -f Dockerfile-15 -t supatype-postgres:15 .

# Build Docker image for PostgreSQL 17
docker build -f Dockerfile-17 -t supatype-postgres:17 .
```

## Next Steps

Now that you understand the basics of Supatype Postgres:

* Check the [Installation Guide](https://github.com/supatype/postgres/wiki) for deployment options
...
* Join the [Supabase Community](https://github.com/supatype/postgres/discussions) for questions and discussions
...
See all installation instructions in the [repo wiki](https://github.com/supatype/postgres/wiki).

[![Docker](https://github.com/supatype/postgres/blob/develop/docs/img/docker.png)](https://github.com/supatype/postgres/wiki/Docker)
[![AWS](https://github.com/supatype/postgres/blob/develop/docs/img/aws.png)](https://github.com/supatype/postgres/wiki/AWS-EC2)

<!-- ### Marketplace Images
TODO: find way to automate this
|   | Postgres & Extensions | PgBouncer | PostgREST | WAL-G |
|---|:---:|:---:|:---:|:---:|
| Supatype Postgres |  ✔️   | ❌    | ❌   |  ✔️   |
| Supatype Postgres: PgBouncer Bundle  |  ✔️   |  ✔️  | ❌    |   ✔️ |
| Supatype Postgres: PostgREST Bundle |  ✔️   |  ❌  |  ✔️   |   ✔️ |
| Supatype Postgres: Complete Bundle |  ✔️  |  ✔️   | ✔️   | ✔️   |

#### Availability
|   | AWS ARM | AWS x86 | Digital Ocean x86 |
|---|:---:|:---:|:---:|
| Supatype Postgres | Coming Soon | Coming Soon | Coming Soon |
| Supatype Postgres: PgBouncer Bundle  | Coming Soon | Coming Soon | Coming Soon |
| Supatype Postgres: PostgREST Bundle | Coming Soon | Coming Soon | Coming Soon |
| Supatype Postgres: Complete Bundle | Coming Soon | Coming Soon | Coming Soon |
